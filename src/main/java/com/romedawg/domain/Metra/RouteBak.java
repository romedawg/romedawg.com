...
public class RouteBak {
    ...
    private RouteBak(Builder builder){
    ...
    public static final class Builder {
        ...
        public RouteBak build(){
            return new RouteBak(this);
        }
    }
    ...
    public RouteBak setRouteId(String routeId) {
        this.routeId = routeId;
        return this;
    }
    ...
    public RouteBak setRouteShortName(String routeShortName) {
        this.routeShortName = routeShortName;
        return this;
    }
    ...
    public RouteBak setRouteLongName(String routeLongName) {
        this.routeLongName = routeLongName;
        return this;
    }
    ...
    public RouteBak setRouteDesc(String routeDesc) {
        this.routeDesc = routeDesc;
        return this;
    }
    ...
    public RouteBak setAgencyId(String agencyId) {
        this.agencyId = agencyId;
        return this;
    }
    ...
    public RouteBak setRouteType(Integer routeType) {
        this.routeType = routeType;
        return this;
    }
    ...
    public RouteBak setRouteColor(String routeColor) {
        this.routeColor = routeColor;
        return this;
    }
    ...
    public RouteBak setRouteTextColor(String routeTextColor) {
        this.routeTextColor = routeTextColor;
        return this;
    }
    ...
    public RouteBak setRouteUrl(String routeUrl) {
        this.routeUrl = routeUrl;
        return this;
    }
